var oData = [
  {
    ...
    data: [
      ...
      {
        name: 'bejson',
        decription: '一个在线格式化json、js、css代码等的在线工具',
        link: 'http://www.bejson.com/'
      },
      {
        name: 'Google',
        decription: '一个需要翻墙才能访问的网站',
        link: 'https://www.google.com/'
      },
      {
        name: 'Dummy Image',
        decription: '在线生成各种大小颜色的占位图',
    ...
    data: [
      {
        name: '博客园',
        decription: '博客园',
        link: 'https://www.cnblogs.com/jiaoshou/'
      },
      {
        name: '码云 git代码托管',
        decription: '码云 git代码托管',
        link: 'https://gitee.com/'
      },
      {
        name: 'coding git代码托管',
        decription: 'coding git代码托管',
        link: 'https://coding.net/git'
      },
      {
        name: 'GitHub',
        decription: '代码版本管理',
      ...
      {
        name: 'cdnjs CDN',
        decription: 'cdnjs CDN',
        link: 'https://cdnjs.com/'
      },
      {
        name: '开放静态文件 CDN',
        decription: '开放静态文件 CDN',
        link: 'http://staticfile.org/'
      },
      {
        name: 'Iconfont-阿里巴巴矢量图标库',
        decription: 'Iconfont-阿里巴巴矢量图标库',
      ...
      {
        name: '在线正则表达式测试',
        decription: '在线正则表达式测试',
        link: 'http://tool.oschina.net/regex'
      },
      {
        name: '图片在线转换Base64编码',
        decription: '图片在线转换Base64编码',
      ...
      {
        name: 'JS代码自动命名反压缩',
        decription: 'JS代码自动命名反压缩',
        link: 'http://www.jsnice.org/'
      },
      {
        name: 'CodePen',
        decription: 'CodePen',
  ...
  },
  {
    ...
    data:[
      {
        name: 'Stack Overflow',
        decription: '全球IT界最受欢迎的与程序相关的IT技术问答网站',
      ...
      {
        name: 'HTML中文网',
        decription: '前端翻译问答，视频教学',
        link: 'https://www.html.cn/'
      },
      {
        name: 'Segmentgault',
        decription: '开发者技术社区',
      ...
      },
      {
        name: '叶小钗',
        decription: '叶小钗',
        link: 'https://www.cnblogs.com/yexiaochai/'
      },
      {
        name: '轩枫阁',
        decription: '前端博客',
  ...
  },
  {
    ...
    data:[
      {
        name: 'AlloyTeam - 腾讯前端团队',
        decription: 'AlloyTeam - 腾讯前端团队',
        link: 'http://www.alloyteam.com/'
      },
      {
        name: 'FEX - 百度前端研发部',
        decription: 'FEX - 百度前端研发部',
        link: 'http://fex.baidu.com/'
      },
      {
        name: 'FED - 淘宝前端团队',
        decription: 'FED - 淘宝前端团队',
        link: 'http://taobaofed.org/'
      },
      {
        name: '奇舞团 | 360前端开发团队',
        decription: '奇舞团 | 360前端开发团队',
      ...
      {
        name: '携程UED | 前端开发团队',
        decription: '携程UED | 前端开发团队',
        link: 'http://ued.ctrip.com/'
      },
      {
        name: '百度EFE | 百度开发团队',
        decription: '百度EFE | 百度开发团队',
        link: 'https://efe.baidu.com/'
      },
      {
        name: '新浪UED | 前端开发',
        decription: '新浪UED | 前端开发',
        link: 'http://ued.sina.com.cn/'
      },
      {
        name: 'Web前端 | 腾讯IMWeb团队',
        decription: 'Web前端 | 腾讯IMWeb团队',
        link: 'https://imweb.io/'
      }
    ]
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        decription: 'Javascript设计模式系列-AlloyTeam',
        link: 'http://www.alloyteam.com/2012/10/commonly-javascript-design-patterns-state-mode/'
      },
      {
        name: '深入理解JavaScript系列-汤姆大叔',
        decription: '深入理解JavaScript系列-汤姆大叔',
      ...
      {
        name: 'Docker概念解析',
        decription: 'Docker概念解析',
        link: 'https://mp.weixin.qq.com/s/sYl17mf0IcjGQHPCz7TUBg'
      },
      {
        name: '前端常见跨域解决方案',
        decription: '前端常见跨域解决方案',
      ...
      {
        name: 'Vue项目 - 仿豆瓣手机端',
        decription: 'Vue项目 - 仿豆瓣手机端',
        link: 'https://www.vue-js.com/topic/5902d41a4d2e582056ec6b1e'
      },
      {
        name: 'Vue项目 - 仿饿了么',
        decription: 'Vue项目 - 仿饿了么',
        link: 'https://github.com/bailicangdu/vue2-elm'
      },
      {
        name: '微信小程序实战—知乎日报',
        decription: '微信小程序实战—知乎日报',
        link: 'https://www.jianshu.com/p/cf329e4dc950'
      },
      {
        name: '如何在vue面试环节，展示你晋级阿里P6+的技术功底？',
        decription: '如何在vue面试环节，展示你晋级阿里P6+的技术功底？',
        link: 'https://www.imooc.com/article/34154'
      },
      {
        name: 'JavaScript 闭包究竟是什么',
        decription: 'JavaScript 闭包究竟是什么',
        link: 'https://www.cnblogs.com/dolphinX/archive/2012/09/29/2708763.html'
      },
      {
        name: 'JS如何区分Object与Aarry的六种方法',
        decription: 'JS如何区分Object与Aarry的六种方法',
      ...
      },
      {
        name: '常用正则表达式',
        decription: '常用正则表达式',
        link: 'https://www.jb51.net/tools/regex.htm'
      },
      {
        name: '大公司里怎样开发和部署前端代码？',
        decription: '大公司里怎样开发和部署前端代码？',
      ...
      },
      {
        ...
        decription: 'Sass Guidelines中文版本之四：项目文件管理',
      ...
      },
      {
        ...
        decription: '移动前端开发之viewport的深入理解',
        link: 'https://www.cnblogs.com/2050/p/3877280.html'
      },
      {
        name: '阿里巴巴73款开源产品全向图',
        decription: '阿里巴巴73款开源产品全向图',
        link: 'https://zhuanlan.zhihu.com/p/22814243'
      },
      {
        name: '微信小程序源码案例大全',
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        decription: 'webpack多页应用架构系列',
        link: 'https://segmentfault.com/a/1190000006843916'
      },
      {
        name: 'package.json文档',
        decription: 'package.json参数解析',
        link: 'http://www.mujiang.info/translation/npmjs/files/package.json.html#devDependencies'
      },
      {
        name: 'JavaScript Promise迷你书',
        decription: 'JavaScript Promise迷你书',
        link: 'http://liubin.org/promises-book/'
      },
      {
        name: 'jQuery 使用手册',
        decription: 'jQuery 使用手册',
        link: 'http://hemin.cn/jq/'
      },
      {
        name: 'Next使用文档',
        decription: 'Hexo主题',
        link: 'http://theme-next.iissnan.com/getting-started.html'
      },
      {
        name: 'Docker —— 从入门到实践',
        decription: 'Docker —— 从入门到实践',
        link: 'https://yeasy.gitbooks.io/docker_practice/content/basic_concept/container.html'
      },
      {
        name: 'Vue.js',
        decription: 'Vue.js开发文档',
        link: 'https://vue.docschina.org/v2/guide/'
      },
      {
        name: 'Underscore.is API中文文档',
        decription: 'Underscore.is API中文文档',
        link: 'https://www.html.cn/doc/underscore/'
      },
      {
        name: 'Sass API文档',
        decription: 'Sass API文档',
        link: 'http://sass.bootcss.com/docs/sass-reference/'
      },
      {
        name: 'Backbone.js API中文文档',
        decription: 'Backbone.js API中文文档',
        link: 'https://www.html.cn/doc/backbone/'
      },
      {
        name: 'Emmet文档 HTML+CSS快捷键',
        decription: 'Emmet文档 HTML+CSS快捷键',
        link: 'https://docs.emmet.io/cheat-sheet/'
      },
      {
        name: 'Chrome扩展开发文档 - 中文版',
        decription: 'Chrome扩展开发文档 - 中文版',
        link: 'http://open.se.360.cn/open/extension_dev/overview.html'
      },
      {
        name: 'Express Node开发框架',
        decription: 'Express Node开发框架',
        link: 'http://www.expressjs.com.cn/'
      },
      {
        name: 'Koa Node开发框架（轻量）',
        decription: 'Koa Node开发框架（轻量）',
  ...
  },
  {
    ...
    data: [
      {
        name: ' Ant Design  - 适用多种框架UI组件库（PC端 React框架适配最佳）',
        decription: '企业级产品设计体系，创造高效愉悦的工作体验',
        link: 'https://ant.design/index-cn'
      },
      {
        name: 'element - Vue PC端组件库',
        decription: '基于 Vue 2.0 的桌面端组件库',
        link: 'https://element.eleme.io/'
      },
      {
        name: 'Vant - Vue 移动端组件库',
  ...
  },
  {
    ...
    data: [
      ...
      {
        name: 'D3.js - JavaScript库',
        decription: 'JavaScript可视化图表库',
        link: 'https://d3js.org/'
      },
      {
        name: 'Unity3D - JavaScript库',
        decription: '一个让玩家轻松创建诸如三维视频游戏、建筑可视化、实时三维动画等类型互动内容的多平台的综合型游戏开发工具',
        link: 'https://docs.unity3d.com/Manual/index.html'
      },
      {
        name: 'cocos2d - JavaScript库',
        decription: '一套成熟的开源跨平台游戏开发框架',
      ...
      },
      {
        ...
        decription: 'animate.css 动画库',
        link: 'https://daneden.github.io/animate.css/'
      },
      {
        name: 'Magic - CSS3动画库',
        decription: 'Magic CSS3动画库',
        link: 'https://www.minimamente.com/project/magic//'
      },
      {
        name: 'Hover.css悬停效果集合 - CSS3动画库',
        decription: 'Hover.css悬停效果集合',
